...
from precipitation.models.architectures.embedding import SinusoidalPosEmb
...
class PrecipitationUnetConvNextBlock(nn.Module):
    """
    Only implemented for 3 upsampling layers.
    """
    def __init__(
        self,
        dim,
        ...
        self.ups = nn.ModuleList([])
        num_resolutions = len(in_out)
        upsampling_output_paddings = [(0,1), (1,0), (1,1)]
...
if __name__ == "__main__":
    # test for precipitation data shapes
    unet = PrecipitationUnetConvNextBlock(dim=64, out_dim=1, channels=21, with_time_emb=False, output_mean_scale=False)
