...
--trainer.logger.class_path "lightning.pytorch.loggers.TensorBoardLogger" --trainer.logger.save_dir "/home/gregor/precipitation/eva_precipitation/logs" --trainer.logger.name "UNet-64-0.2_featureset7" \
